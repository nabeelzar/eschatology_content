...
There are different grades of hadith demarcating their authenticity, we will use the standard grades whenever presenting a hadith: Sahih (Strong/Sound), Hasan (Good), Da'if (Weak) 
